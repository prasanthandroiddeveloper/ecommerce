package com.naestech.prasanth.myhita.helper;

import com.naestech.prasanth.myhita.model.Category;
import com.naestech.prasanth.myhita.model.Offer;
...
public class Data {
    ...
    public List<Product> getNewList() {
        Product product = new Product("1", "1", "Apple", "", "1 Kg", "Rs.", "20", "10% OFF", "http://1.bp.blogspot.com/-MMt-60IWEdw/VqZsh45Dv8I/AAAAAAAAMHg/70D9tVowlyc/s1600/askmegrocery-republic-day-offer.jpg");
        newList.add(product);
        product = new Product("2", "1", "Banana", "", "1 Bounch", "Rs.", "10", "20% OFF", "http://www.lootkaro.com/wp-content/uploads/2016/05/as1.jpg");
        newList.add(product);
        product = new Product("3", "2", "House Clean Liquid", "", "1 Lit.", "Rs.", "25", "", "https://453xbcknr3t3ahr522mms518-wpengine.netdna-ssl.com/wp-content/themes/iga-west/images/banner-save-more.jpg");
        newList.add(product);
        product = new Product("4", "2", "House Clean Liquid", "", "1 Lit.", "Rs.", "25", "", "https://images-eu.ssl-images-amazon.com/images/G/31/img16/Grocery/SVD/July18/750x375.png");
        newList.add(product);
